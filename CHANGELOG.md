...
- Brightness slider controls for 6 lights

## [2.0.4] - 2026-04-06

### Fixed

- Bus 24 is Wohnen group switch, not outside light. Renamed and moved in dashboard

## [2.0.3] - 2026-04-06

### Added

- Outside light (LED strip, bus 24) as 9th controllable light

## [2.0.2] - 2026-04-06

### Fixed

- 6 of 8 lights not created — changed all to ONOFF mode

## [2.0.1] - 2026-04-06

### Fixed

- Import error: removed unused ATTR_COLOR_TEMP import
